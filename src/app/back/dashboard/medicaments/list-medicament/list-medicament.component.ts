...
export class ListMedicamentComponent {
  ...
  viewMedicament(medoc: Medicaments): void {
    console.log(medoc.id);
    this.router.navigate(['dashboard/medicaments/detail-medicament/', medoc.id]);
  }
